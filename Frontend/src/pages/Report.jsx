...
const Report = () => {
  ...
  const loadIncome = async () => {
    try {
      const result = await axios.get(`http://${process.env.REACT_APP_API_URL}/income/totalincomeperiode`, {
        params: {
  ...
  const loadOutcome = async () => {
    try {
      const result = await axios.get(`http://${process.env.REACT_APP_API_URL}/outcome/total`, {
        params: {
          username: Cookies.get("username"),
          startDate: startSTR,
          endDate: endSTR,

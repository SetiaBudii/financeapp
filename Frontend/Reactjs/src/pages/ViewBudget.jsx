...
const ViewBudget = () => {
    ...
    const DeleteCategory = async (event) => {
        ...
        try {
            const result = await axios.delete(`http://localhost:5000/kategori/${deleteCategory.id_kategori}`, { validateStatus: false });
    ...
    return (
        <div id="wrapper">
                                                ...
                                                {allKategori && allKategori.map((kategori) => (
                                                    <tr key={kategori.id_kategori}>
                                                        ...
                                                        <td style={{ width: '30%' }}>
                                                            ...
                                                            <button data-id={kategori.id_kategori} id={kategori.id_kategori} name={kategori.id_kategori} data-toggle="modal" data-target="#deletekategorimodal" onClick={()=> handleDeleteClick(kategori.id_kategori)} >Delete</button>
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
            ...
            <div className="modal fade" id="deletekategorimodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
